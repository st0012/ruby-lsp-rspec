...
class RubyIndexer::Entry::Parameter
  ...
  # @return [Symbol]
  #
  # source://sorbet-runtime/0.5.11316lib/types/private/methods/_methods.rb#257
...
class RubyLsp::Addon
  ...
  sig { abstract.params(global_state: ::RubyLsp::GlobalState, message_queue: ::Thread::Queue).void }
  ...
  class << self
    ...
    def load_addons(global_state, message_queue); end
  end
end
