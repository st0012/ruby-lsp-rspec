...
class RBI::TypedParam < ::T::Struct
  ...
  class << self
    # source://sorbet-runtime/0.5.11604lib/types/struct.rb#13
    def inherited(s); end
  end
end
...
class URI::Source < ::URI::File
  # source://ruby-lsp/0.20.1lib/ruby_lsp/requests/support/source_uri.rb#69
  sig { params(v: T.nilable(::String)).returns(T::Boolean) }
  def check_host(v); end

  # source://uri/0.13.1uri/generic.rb#243
  def gem_name; end

  # source://ruby-lsp/0.20.1lib/ruby_lsp/requests/support/source_uri.rb#33
  sig { returns(T.nilable(::String)) }
  def gem_version; end

  # source://uri/0.13.1uri/generic.rb#283
  def line_number; end

  # source://ruby-lsp/0.20.1lib/ruby_lsp/requests/support/source_uri.rb#59
  sig { params(v: T.nilable(::String)).void }
  def set_path(v); end

  # source://ruby-lsp/0.20.1lib/ruby_lsp/requests/support/source_uri.rb#81
  sig { returns(::String) }
  def to_s; end

  class << self
    # source://ruby-lsp/0.20.1lib/ruby_lsp/requests/support/source_uri.rb#46
    sig do
      params(
        gem_name: ::String,
